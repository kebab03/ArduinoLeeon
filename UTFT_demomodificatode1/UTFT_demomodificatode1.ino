...
// Clear the screen and draw the frame
  ...
  delay(40);
  Serial.print("TFT_eSPI :::");
  myGLCD.setTextColor(TFT_YELLOW,TFT_GREY);


  delay(40);
  Serial.print(" arriva Adapted by Bodmer :::");
...
// Draw crosshairs
  ...
  for (int i=9; i<310; i+=10)
    myGLCD.drawLine(i, 117, i, 121,TFT_RED);
...
*/
  ...
  myGLCD.drawLine(1, 119, 318, 119,TFT_CYAN);
int col = 0;
// Draw a moving sinewave
  ...
  {  delay(40);
    ...
    if (i>318)
    {
      ...
      myGLCD.drawPixel(x,buf[x-1],TFT_RED);
    }
